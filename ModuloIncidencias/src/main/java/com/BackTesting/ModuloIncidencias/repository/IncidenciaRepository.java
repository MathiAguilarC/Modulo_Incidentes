...
public interface IncidenciaRepository extends JpaRepository<Incidencia, Integer> {
    ...
    @Query("SELECT i FROM Incidencia i JOIN FETCH i.reporte r WHERE i.estado = 'Pendiente' OR i.empleadoSoporte IS NULL")
    List<Incidencia> findIncidenciasPendientesOSinAsignar();
